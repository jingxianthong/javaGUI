...
public class PaymentCollection extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
                // TODO add your handling code here:
    boolean creditCardSelected = jToggleButton1.isSelected();
    boolean tngSelected = jToggleButton2.isSelected();
    if (!creditCardSelected && !tngSelected) {
        JOptionPane.showMessageDialog(this, "Please select a payment method.");
        return; // Stop further processing
    }
    
    // Check if payment amount is entered
    String paymentAmountText = jTextField3.getText().trim();
    if (paymentAmountText.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Please enter the payment amount.");
        return; // Stop further processing
    }
    
    int option = JOptionPane.showConfirmDialog(this, "Booked Successful!", "Confirmation", JOptionPane.YES_NO_OPTION);
