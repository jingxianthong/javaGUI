...
public class Technician_selected01 extends javax.swing.JPanel {
    ...
    int option = JOptionPane.showConfirmDialog(this, "Do you want to submit?", "Confirmation", JOptionPane.YES_NO_OPTION);
    
    if (option == JOptionPane.YES_OPTION) {
        // If user selects "Yes", proceed to the next page
        TechinicianTaskComplete newpage = new TechinicianTaskComplete();
        
        // Get the JFrame containing this panel
        JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(this);

        // Replace current panel with Technician_Submit02 panel
        frame.getContentPane().removeAll(); // Remove all components from the frame
        frame.getContentPane().add(newpage); // Add Technician_Submit02 panel
        frame.pack(); // Resize frame to fit the new panel
    }
