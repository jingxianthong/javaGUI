 ...
 * @author thong
 */
public class ManagementPaymentCollection extends javax.swing.JPanel {
        public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Login Frame");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.getContentPane().add(new ManagementPaymentCollection()); // Instantiate and add your login panel
            frame.pack();
     ...
     */
    public ManagementPaymentCollection() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Payment Collection - AHHASC ");
        ...
        jLabel5.setText("Payment Date: dd/mm/yyyy");
